...
/* Función que cifra un texto usando AES128 con el modo CBC */
function mc_encrypt_128($encrypt, $key){
...
/* Función que descifra un texto usando AES128 con el modo CBC */
function mc_decrypt_128($decrypt, $key){
...
/* Función que cifra un texto usando AES256 con el modo CBC */
function mc_encrypt_256($encrypt, $key){
	$encrypt = serialize($encrypt);
...
/* Función que descifra un texto usando AES256 con el modo CBC */
function mc_decrypt_256($decrypt, $key){
	$decrypt = explode('|', $decrypt);
	$decoded = base64_decode($decrypt[0]);
	$iv = base64_decode($decrypt[1]);
